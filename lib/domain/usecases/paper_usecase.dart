...
class PaperUseCase {
  ...
  Future<PaperEntity> updatePaper(
    ...
    return repository.updatePaper(id, title, authors, year, category, filePath);
  }

  Future<List<PaperEntity>> viewPapers() {
    return repository.viewPapers();
  }

  Future<void> deletePaper(String id) {
    return repository.deletePaper(id);
  }
}
